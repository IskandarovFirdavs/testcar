          ...
          <InputsDiv>
            <FormEmail ref={form} onSubmit={sendEmail}>
              ...
              <Input
                name="from_belgi"
                type="text"
                placeholder="📃   Haydovchi ushlab turadigan yozuvdagi ism"
              />
              ...
              <Input
                type="number"
                name="from_email"
                placeholder="📨    Telefon raqamingiz :  +998 12 345 67 89"
              />
              <Placeholder
                name="Izoh :"
                placeholder="💬 Talablar: Yuk haqida ma'lumot, maxsus talablar yoki haydovchiga so'rovlar"
              />
